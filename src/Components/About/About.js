            ...
            <div className='about-block'>
                ...
                <div className='about-content'>
                    <div>
                        ...
                        <p align="justify">О моих навыках вы можете прочитать выше, а здесь я расскажу о себе. Мне 22 года и я занимаюсь разработкой (как уже можно было догадаться). Для меня это не только средство заработка, но и хобби. Часто, меня переполняет желаение изучить какую-то новую технологию или язык программирования, и это дает мне не только опыт, но и хорошее настроение.
